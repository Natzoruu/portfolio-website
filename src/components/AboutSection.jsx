                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            I’m a Multimedia Engineering student with a strong foundation in web development and digital design. I enjoy creating elegant and efficient solutions that blend visual appeal with performance and usability.
                        </p>
                        <p className="text-muted-foreground">
                            My main tools include React, Tailwind CSS, JavaScript, and WordPress — where I build dynamic, scalable, and fully customized websites. I’m particularly focused on creating responsive and accessible user experiences, whether starting from scratch or optimizing existing platforms.
                        </p>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">I’ve collaborated with classmates and local clients on small-scale website projects, taking care of both design and development. These experiences have helped me improve my communication, planning, and technical skills in real-world scenarios.</p>
                                </div>
                            </div>
                        </div>
                    </div>
