                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="www.linkedin.com/in/ajsz2205" className="p-3 rounded-full bg-primary/10 text-primary"><Linkedin/></a>
                                <a href="https://github.com/Natzoruu" className="p-3 rounded-full bg-primary/10 text-primary"><Github/></a>
                            </div>
                        </div>
                    </div>
